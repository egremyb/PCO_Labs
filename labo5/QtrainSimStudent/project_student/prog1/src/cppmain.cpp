...
int cmain()
{
    ...
    /***********************************************************
     * Parcours des locomotives (partie partagée= 'a b c ...') *
     ***********************************************************/

    // parcours loco A : '25 24 23',     16,  '15 14 7 6',  5,  '34 33 32'
    // parcours loco B : '22 21 20 19',  13,  '15 14 7 6',  1,  '31 30 29 28'
    ...
    unsigned startA              = 25;
    unsigned forwardContactsA[]  = {23, 16};
    unsigned backwardContactsA[] = {34, 5};
    unsigned forwardPointsA[]    = {9, DEVIE};
    unsigned backwardPointsA[]   = {2, DEVIE};

    unsigned startB              = 22;
    unsigned forwardContactsB[]  = {19, 13};
    unsigned backwardContactsB[] = {31, 1};
    ...
    std::unique_ptr<Launchable> locoBehaveA = std::make_unique<LocomotiveBehavior>(locoA, sharedSection, startA, forwardContactsA, backwardContactsA, forwardPointsA, backwardPointsA);
    // Création du thread pour la loco 1
    std::unique_ptr<Launchable> locoBehaveB = std::make_unique<LocomotiveBehavior>(locoB, sharedSection, startB, forwardContactsB, backwardContactsB, forwardPointsB, backwardPointsB);
